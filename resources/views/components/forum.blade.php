            ...
            @foreach ($sessionLearning->forumPosts as $post)
                <li class="border-bottom pb-2 mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <small class="text-muted"><a href="{{ asset('storage/Forums/' . basename($post->FilePath)) }}" download target="_blank">Link File</a></small>
                    </div>
                    ...
                    <ul class="mt-2 ps-4 border-start">
                        @foreach ($post->replies as $reply)
                            <li class="d-flex flex-column">
                                ...
                                <small class="text-muted"><a href="{{ asset('storage/Forums/Replies/' . basename($reply->FilePath)) }}" download target="_blank">Link File</a></small>
                            </li>
                        @endforeach
                    </ul>
